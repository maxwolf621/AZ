...
1. The `assigned` membership type lets you `MANUALLY` add specific users to be members of the group and to have unique permissions.
...
- because **security groups can `only be used for devices or users `and not for groups.**
